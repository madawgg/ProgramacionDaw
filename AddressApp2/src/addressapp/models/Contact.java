...
public class Contact {
    ...
    public Contact(String nom, String cognoms, String domicili, String ciutat, int cp, int dia, int mes, int any){
        ...
        this.data_de_naixement = new SimpleObjectProperty<>(LocalDate.of(any, mes,dia));
    }
    public Contact(){
